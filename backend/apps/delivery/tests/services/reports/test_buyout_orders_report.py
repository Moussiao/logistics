...
@pytest.mark.freeze_time("2022-07-01 14:00")
def test_empty_previous_day(utc_time_zone: "TimeZone", partner_factory: "PartnerFactory") -> None:
    partner = partner_factory(working_time_zone=utc_time_zone)
    previous_day_report = PreviousDayBuyoutedOrders(partner=partner)
...
def test_error_previous_day(utc_time_zone: "TimeZone", partner_factory: "PartnerFactory") -> None:
    partner = partner_factory(working_time_zone=utc_time_zone)
    previous_day_report = PreviousDayBuyoutedOrders(partner=partner)
...
@pytest.mark.freeze_time("2022-07-01 14:00")
def test_empty_previous_month(utc_time_zone: "TimeZone", partner_factory: "PartnerFactory") -> None:
    partner = partner_factory(working_time_zone=utc_time_zone)
...
def test_error_previous_month(partner: "Partner") -> None:
    previous_month_report = PreviousMonthBuyoutedOrders(partner=partner)
