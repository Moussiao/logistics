...
if TYPE_CHECKING:
    from backend.apps.delivery.tests.api.conftest import CustomerRequestFactory, OrderRequestFactory
...
def test_create_order(
    partner: Partner, admin_client: Client, order_request_factory: "OrderRequestFactory"
) -> None:
