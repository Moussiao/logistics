...
from backend.apps.delivery.models import (
    Customer,
    CustomerAddress,
    Order,
    OrderProduct,
...
from backend.apps.delivery.services.orders.exceptions import (
    DuplicateExternalIdOrderError,
    InvalidCountryCodeOrderError,
    PartnerNotExistsOrderError,
)
from backend.apps.geo.models import City, Region
from backend.apps.geo.services import GetCountryByCode, InvalidCountryCodeError

if TYPE_CHECKING:
    from backend.apps.delivery.api.schemas import OrderRequest
