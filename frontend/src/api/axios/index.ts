...
export const createCustomAxiosInstance = (userConfig: Partial<CustomAxiosInstanceConfig> = {}) => {
  const defaultConfig = {
  ...
  instance.interceptors.request.use((value) => onRequestFulfilled(value, useRequestCaseMiddleware));
